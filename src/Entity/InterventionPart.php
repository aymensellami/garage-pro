...
class InterventionPart
{
    ...
    public function getUnitPriceAtTime(): ?string { return $this->unitPriceAtTime; }
    public function setUnitPriceAtTime(string $unitPriceAtTime): static { $this->unitPriceAtTime = $unitPriceAtTime; return $this; }
    public function getDiscountPercent(): ?string { return $this->discountPercent; }
    public function setDiscountPercent(?string $discountPercent): static { $this->discountPercent = $discountPercent; return $this; }
