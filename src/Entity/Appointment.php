...
class Appointment
{
    ...
    public function confirm(): static { $this->status = self::STATUS_CONFIRMED; return $this; }
    public function cancel(): static { $this->status = self::STATUS_CANCELLED; return $this; }
    public function reschedule(\DateTimeInterface $newDate): static { $this->scheduledAt = $newDate; return $this; }
    public function isOverdue(): bool { return $this->status === self::STATUS_REQUESTED && $this->scheduledAt < new \DateTime(); }
}
