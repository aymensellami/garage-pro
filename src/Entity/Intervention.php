...
class Intervention
{
    ...
    public function getMechanic(): ?User { return $this->mechanic; }
    public function setMechanic(?User $mechanic): static { $this->mechanic = $mechanic; return $this; }
    ...
    public function getFinalCost(): ?string { return $this->finalCost; }
    public function setFinalCost(?string $finalCost): static { $this->finalCost = $finalCost; return $this; }
    ...
    {
        return array_sum($this->interventionParts->map(fn(InterventionPart $ip) => $ip->getTotal())->toArray());
    }

    public function getProfitMargin(): ?float
    {
        if ($this->finalCost === null) return null;
