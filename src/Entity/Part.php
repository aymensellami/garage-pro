...
class Part
{
    ...
    public function getMinStockAlert(): ?int { return $this->minStockAlert; }
    public function setMinStockAlert(int $minStockAlert): static { $this->minStockAlert = $minStockAlert; return $this; }
    ...
    {
        if ($this->stockQuantity <= 0) return self::STATUS_OUT;
        if ($this->stockQuantity <= $this->minStockAlert) return self::STATUS_LOW;
        return self::STATUS_OK;
    }

    public function isLowStock(): bool { return $this->getStockStatus() === self::STATUS_LOW; }
    public function isOutOfStock(): bool { return $this->getStockStatus() === self::STATUS_OUT; }
    ...
    {
        if ($this->stockQuantity < $qty) return false;
    ...
    public function getInterventionParts(): Collection { return $this->interventionParts; }
