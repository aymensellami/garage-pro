...
class StockMovement
{
    ...
    public function isEntry(): bool { return in_array($this->type, [self::TYPE_ENTRY, self::TYPE_RETURN, self::TYPE_INITIAL]); }
    public function isExit(): bool { return $this->type === self::TYPE_EXIT; }
